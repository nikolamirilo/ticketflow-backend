...
export async function sendEmail(subject, to, title, description, full_name) {
  try {
                            ...
                            <td>
                              <table align="center" width="100%" border="0" cellPadding="0" cellSpacing="0" role="presentation">
                                <tbody style="width:100%">
                                  <tr style="width:100%"><img src="https://react-email-demo-jsqyb0z9w-resend.vercel.app/static/yelp-header.png" style="display:block;outline:none;border:none;text-decoration:none;max-width:100%" width="620" /></tr>
                                </tbody>
                              </table>
                                ...
                                <tbody style="width:100%">
                                  <tr style="width:100%">
                                    <td data-id="__react-email-column">
                                      <h1 style="font-size:28px;font-weight:bold;text-align:center">Hi ${full_name},</h1>
                                      <h2 style="font-size:22px;font-weight:bold;text-align:center">${title}</h2>
                                      <p style="font-size:16px;line-height:24px;margin:16px 0"><b>Time: </b>September 7, 2022 at 10:58 AM</p>
                                      <p style="font-size:16px;line-height:24px;margin:16px 0;margin-top:-5px"><b>Location: </b>Upland, California, United States</p>
